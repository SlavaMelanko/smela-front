...
export const ADMIN_TEAMS_MEMBERS_PATH = '/api/v1/admin/teams/:teamId/members'
export const ADMIN_TEAMS_RESEND_INVITE_PATH =
  '/api/v1/admin/teams/:teamId/members/:memberId/resend-invite'

// Owner endpoints
export const OWNER_ADMINS_PATH = '/api/v1/owner/admins'
export const OWNER_ADMINS_RESEND_INVITE_PATH =
  '/api/v1/owner/admins/:adminId/resend-invite'
